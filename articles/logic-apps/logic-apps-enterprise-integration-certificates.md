...
provide these details for your certificate. When you're done, choose **OK**.
   ...
   | **Certificate** | <*certificate-file-name*> | To find and select the certificate file you want to upload, choose the folder icon next to the **Certificate** box. When using a key vault for the private key this will be the public certificate. | 
